...
const { loginEngineer, engineerLogin } = require('./engineerController')
const { registerUser, loginUser, userLogin, logoutUser } = require('./userController')
...
// Engineer Router
router.post('/engineer/register', verifyAdmin ,registerAdmin)
